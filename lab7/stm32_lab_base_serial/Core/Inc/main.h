...
#define GPIO_B_H      {HAL_GPIO_WritePin(GPIO_B_GPIO_Port, GPIO_B_Pin, GPIO_PIN_SET);}
#define GPIO_B_L      {HAL_GPIO_WritePin(GPIO_B_GPIO_Port, GPIO_B_Pin, GPIO_PIN_RESET);}
